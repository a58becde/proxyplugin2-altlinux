window.addEventListener("FireBreathLoadedEvent", function(e){
    console.log(e.detail.message)
    var data = e.detail.message.split('|');
    FireBreathLoadPlugin(data[0], data[1])
});

function FireBreathLoadPlugin(id, function_name){

    window[function_name]((function() {

        var firebreath = {extId: id};
        ...
        (function() {
            ...
            function post_rel(def_obg){
                if (def_obg.getState() > 2){
                    def_obg.release();
                } else {
                    setTimeout(function() {post_rel(def_obg);}, 1000);
                }
            }
            ...
            function DeferredObject(name) {
                ...
                setTimeout(function() {post_rel(self);}, 1000);
            }
        ...
        (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
                ...
                function addWyrmlingStore(baseStore, spawnId, rootObject) {
                    ...
                    Object.defineProperties(newStore, {
                        ...
                        releaseQueelings: { value: function() {
                                Object.keys(newStore).forEach(function(objectId) {
                                    if (!locked_queelings.some(x => x == newStore.getObject(objectId))){
                                        newStore.releaseObject(objectId);
                                    }
                                });
                            }},
                        lockQueeling: { value: function(queeling) {
                                locked_queelings.push(queeling);
                            }},
                ...
                function wrapAlienWyrmling(wyrmhole, wyrmlingStore, spawnId, objectId) {
                    ...
                    defineProperties(wyrmling, {
                        ...
                        getProperty: function(prop) {
                            var propValue;
                            var getPromise = released ? releasedFailure : sendLock(['GetP', spawnId, objectId, prop]).then(function(val) {
                        ...
                        release_queenlings: function() {
                            wyrmlingStore.releaseQueelings();
                        },
                        lock_queenling: function(queeling) {
                            wyrmlingStore.lockQueeling(queeling);
                        },
        ...
        (function(fb) {
            ...
            var nativeHostApp = "ru.intertrust.firewyrmhost";
